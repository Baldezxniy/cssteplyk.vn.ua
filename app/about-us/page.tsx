              ...
              <div className='w-full text-[#676767]'>
                <div className='py-[40px]'>
                  <div className='text-left relative'>
                    <div className="flex-col lg:flex-row flex justify-around  gap-5">
                      <div className="flex flex-col lg:w-[600px]">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold lg:mb-5 xl:mb-10">
                          Ласкаво просимо на сайт Теплицької Спортивної Школи – це місце мрій та формування майбутніх
                          чемпіонів!
                        </h1>
                        <div className="text-[18px] xl:text-xl hidden lg:block">
                          Наша школа – це інноваційний центр, створений для розвитку фізичних та розумових здібностей
                          молоді. Наша
                          команда професійних тренерів та педагогів пропонує унікальні програми з різних видів спорту,
                          адаптовані до
