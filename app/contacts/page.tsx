...
export const metadata: Metadata = {
  title: 'Контакти - Теплицька спортивна школа в Теплику',
  description: 'Зв\'яжіться з Теплицькою спортивною школою в місті Теплику за допомогою наших контактних даних. Ми готові відповісти на ваші питання та допомогти з усіма питаннями, що стосуються нашої діяльності.',
  keywords: [
    'контакти теплик',
    'контактна інформація теплик',
    'телефон теплицької спортивної школи',
    'адреса теплицької спортивної школи',
    'електронна пошта теплицької спортивної школи',
    'як зв\'язатися з теплицькою спортивною школою',
    'теплик школа контакти',
    'контактна інформація про нас теплик',
    'теплик страдіон контакти',
    'теплик спорт контакти',
    'спорт теплик контакти',
    'теплик школа контакти',
    'спорт школа контакти',
    'спортшкола контакти',
    'стадіон контакти',
  ],
}
